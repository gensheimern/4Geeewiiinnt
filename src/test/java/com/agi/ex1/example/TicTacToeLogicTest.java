...
public class TicTacToeLogicTest {
    ...
    void test_Draw3x3(){
        ...
        ttt.setChip(Player.X,1,0);
        ttt.setChip(Player.O,2,0);

        ttt.setChip(Player.O,0,1);
        ttt.setChip(Player.X,1,1);
        ttt.setChip(Player.O,2,1);

        ttt.setChip(Player.X,0,2);
        ttt.setChip(Player.O,1,2);

        assertEquals(Ergebnis.DRAW, ttt.setChip(Player.X,2,2));
    ...
    void test_Draw4x4(){
        ...
        ttt.setChip(Player.X,1,0);
        ttt.setChip(Player.O,2,0);
        ttt.setChip(Player.X,3,0);

        ttt.setChip(Player.O,0,1);
        ttt.setChip(Player.X,1,1);
        ttt.setChip(Player.O,2,1);
        ttt.setChip(Player.O,3,1);

        ttt.setChip(Player.X,0,2);
        ttt.setChip(Player.O,1,2);
        ttt.setChip(Player.X,2,2);
        ttt.setChip(Player.X,3,2);

        ttt.setChip(Player.X,0,3);
        ttt.setChip(Player.O,1,3);
        ttt.setChip(Player.X,2,3);

        assertEquals(Ergebnis.DRAW, ttt.setChip(Player.O,3,3));
